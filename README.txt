...
In the folder admission_contact, type: 'make debug' to get a debug version of the library. This will print more output on the screen
In both above cases, you should get an executable called 'admission_contact' in the same folder.

Running admission contact :
In the folder admission contact, type: ./admission_contact to run the admission contact


Compiling node :
In the folder ui, type: 'make' to get a normal version of the binary
In the folder ui, type: 'make debug' to get a a verbose version of the library.
